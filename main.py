...
if not button_clicked:
    ...
    st.write("""
        <div id="upcoming-races" style="padding: 20px; ">
            ...
            <p>Don't miss out on the excitement! Check out the schedule for upcoming Formula 1 2025 races:</p>
            <div style="display: flex; flex-wrap: wrap;background-color: #000000;">
                <div style="flex: 0 0 33.33%; padding: 10px;">
                    <strong>Australian GP</strong><br>
                    14-16 MARCH
                </div>
                <div style="flex: 0 0 33.33%; padding: 10px;">
                    <strong>China GP</strong><br>
                    21-23 MARCH
                </div>
                <div style="flex: 0 0 33.33%; padding: 10px;">
                    <strong>Japan GP</strong><br>
                    04-06 APRIL
                </div>
            </div>
            <div style="display: flex; flex-wrap: wrap;background-color: #000000;">
                <div style="flex: 0 0 33.33%; padding: 10px;">
                    <strong>Bahrain GP</strong><br>
                    11-13 APRIL
                </div>
                <div style="flex: 0 0 33.33%; padding: 10px;">
                    <strong>Saudi Arabian GP</strong><br>
                    18-20 APRIL
                </div>
                <div style="flex: 0 0 33.33%; padding: 10px;">
